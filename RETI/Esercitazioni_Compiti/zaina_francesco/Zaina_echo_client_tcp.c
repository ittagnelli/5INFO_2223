...
int socket_receive(int socket_fd, char *buf)  //riceve il segmento dal server
{
    int msg_size;
...
int main(int argc, char **argv) 
{
    ...
    /* invio sul socket la stringa */
     ...
     socket_receive(connection_fd, buf);     // chiamata funzione per la ricezione socketACK
