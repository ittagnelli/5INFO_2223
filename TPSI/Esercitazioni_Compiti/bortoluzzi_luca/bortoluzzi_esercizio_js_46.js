...
let auto = new Automobile("Audi", "QWERTY","5","blue","300");
auto.id();
auto.design();
auto.motore();

let auto1 = new Automobile("Rolls Royce", "UIOPAS","5","white","700");
auto1.id();
auto1.design();
auto1.motore();

let auto2 = new Automobile("Smart", "GHJKLN","2","red","100");
auto2.id();
auto2.design();
auto2.motore();

let auto3 = new Automobile("Skoda", "FGHJKF","5","blue","400");
auto3.id();
auto3.design();
auto3.motore();

let auto4 = new Automobile("Panda", "ERTYIJ","4","grey","200");
auto4.id();
auto4.design();
auto4.motore();