...
#define BUFSIZE 1024 //DICHIARAZIONE DIMENSIONE DEL BUF
...
int main(int argc, char **argv)
{
    ...
    // Verifico la presenza di parametri IP e porta
    if(argc != 4) {
    ...
    //ESERCIZIO 3
    socket_receive(socket_fd, buf); //copy paste dal server, ricevo dal client quello che mi e' arrivato dal server
    //FINE
