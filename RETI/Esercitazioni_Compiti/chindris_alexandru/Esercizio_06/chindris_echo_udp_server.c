...
int socket_receive(int socket_fd, char *buf, struct sockaddr_in *clientaddr) // ridichiaro la struttura qua dentro
{
    int msg_size;
...
int socket_send(int socket_fd, char *ip, unsigned short port, char *buf)   // INSERITO
{
    struct sockaddr_in serveraddr; /* indirizzo e porta server nomestruttura + varibile */  
    int byte_sent;
